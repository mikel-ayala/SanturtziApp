...
import com.g2.santurtziapp.Letra
import com.g2.santurtziapp.R
import com.g2.santurtziapp.databinding.FragmentJuego3Binding
import java.util.*
import kotlin.concurrent.schedule

class Juego3Fragment : Fragment() {

    private var _binding: FragmentJuego3Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentJuego3Binding.inflate(layoutInflater)
    ...
    private fun checkIfRangeIsValid(initTag: String, endTag: String){
        ...
        if (found){
            ...
            if (showCongrats){
                ...
                setFragmentResult("juego3", bundleOf("terminado" to "yes"))
            }
